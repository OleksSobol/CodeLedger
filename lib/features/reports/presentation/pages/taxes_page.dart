...
class _TaxesPageState extends ConsumerState<TaxesPage>
  ...
  Widget _buildQuarterlyCards(
    ...
    final dedReceiptTotal = _receipts
        .where((r) => r.isTaxDeductible)
        .fold(0.0, (sum, r) => sum + r.amount);
    ...
    return Column(
      ...
      children: [
        ...
        ...quarters.map((q) {
          ...
          final dedReceiptAlloc = dedReceiptTotal / 4;
          final recurringAlloc = monthlyDeductible * q.months;
          final expAlloc = dedReceiptAlloc + recurringAlloc;
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (gross == 0)
                    ...
                    if (dedReceiptAlloc > 0)
                      _SummaryRow('Receipts (÷4)',
                          '− ${cur.format(dedReceiptAlloc)}', theme),
                    if (recurringAlloc > 0)
