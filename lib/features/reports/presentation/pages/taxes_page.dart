...
class _TaxesPageState extends ConsumerState<TaxesPage>
  ...
  Widget _buildQuarterlyCards(
    ...
    // Only count receipts the user explicitly marked as tax-deductible
    final totalReceiptDeductions =
        _receipts.where((r) => r.isTaxDeductible).fold(0.0, (sum, r) => sum + r.amount);
    // Recurring deductible expenses from the Expenses tab
    ...
    return Column(
      ...
      children: [
        ...
        ...quarters.map((q) {
          ...
          // Recurring expenses cover exactly the months in this IRS quarter
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (gross == 0)
                    ...
                    if (recurringAlloc > 0)
                      _SummaryRow('Recurring expenses (${q.months}mo)',
